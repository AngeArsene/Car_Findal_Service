<x-layouts.main class="page-my-cars" :pagination="false">
    <main>
        <div>
            <div class="container">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="delete_images[]" id="delete_image_2"
                                                value="2" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="number" name="positions[2]" value="2"
                                                style="width: 80px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="delete_images[]" id="delete_image_3"
                                                value="3" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="number" name="positions[3]" value="3"
                                                style="width: 80px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="delete_images[]" id="delete_image_4"
                                                value="4" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="number" name="positions[4]" value="4"
                                                style="width: 80px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="delete_images[]" id="delete_image_5"
                                                value="5" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="number" name="positions[5]" value="5"
                                                style="width: 80px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="delete_images[]" id="delete_image_6"
                                                value="6" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="number" name="positions[6]" value="6"
                                                style="width: 80px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="delete_images[]" id="delete_image_7"
                                                value="7" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="number" name="positions[7]" value="7"
                                                style="width: 80px" />
                                        </td>
                                    </tr>
                                </tbody>
